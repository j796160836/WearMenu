 ...
 */
public class PictureListActivity extends WearableActivity implements AdapterView.OnItemClickListener {

	public static final String TAG = PictureListActivity.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new WearableListAdapter(PictureListActivity.this, WearableListAdapter.ListType.PICTURE, itemStrings, drawablesResId);
