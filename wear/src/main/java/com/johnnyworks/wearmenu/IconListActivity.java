 ...
 */
public class IconListActivity extends WearableActivity implements AdapterView.OnItemClickListener {

	public static final String TAG = IconListActivity.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int[] drawablesResId = mockDrawablesResId();
		mAdapter = new WearableListAdapter(IconListActivity.this, WearableListAdapter.ListType.ICON, itemStrings, drawablesResId);
	...
	public void onItemClick(AdapterView<?> adapterView, View view, int pos, long id) {
		...
		Intent intent = new Intent(IconListActivity.this, PictureListActivity.class);
